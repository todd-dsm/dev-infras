...
#
#  This policy has been scoped-down to the VPC ID.
#  A per-cluster policy is a bit too granular for the current use-case.
#  REF: https://kubernetes-sigs.github.io/aws-load-balancer-controller/v2.3/deploy/installation/#iam-permissions
#  ---------------------------------------------------------|------------------------------------------------------------
#*/
...
#
#  # The VPC needs to be built before this policy is created; see "ec2:Vpc" below.
#  depends_on = [
#    aws_vpc.vpc_network
#  ]
#
...
#            "Condition": {
#                "ArnEquals": {
#                    "ec2:Vpc": "${aws_vpc.vpc_network.arn}"
#                }
#            }
#        },
#        {
